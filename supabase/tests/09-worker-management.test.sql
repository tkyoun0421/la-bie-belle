...
insert into public.profiles (id, name, phone, gender, birth_date, status, inactivity_anchor_at) values
  ('a1000000-0000-0000-0000-000000000001', '관리자', '01070000001', 'male', '1988-01-01', 'active', now()),
  ('a1000000-0000-0000-0000-000000000010', '근무자에이', '01070000010', 'male', '1990-01-01', 'active', now()),
  ('a1000000-0000-0000-0000-000000000011', '근무자비', '01070000011', 'female', '1991-02-02', 'active', now()),
  ('a1000000-0000-0000-0000-000000000012', '근무자씨', '01070000012', 'male', '1992-03-03', 'active', now()),
  ('a1000000-0000-0000-0000-000000000013', '근무자디', '01070000013', 'male', '1993-04-04', 'pending', null);
