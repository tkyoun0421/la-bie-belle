...
근무 요청 UI 시안 검수가 다음 첫 수다. 도메인·화면 문서·시안이 이번 회차(#265~#267)로 다 정본에 들어갔고, 남은 건 새로 생긴 「제안」 판정이다 — 요청 시트 제목 짜임·CTA 배치, 끝난 요청 문구, 배지 문구·모양, 픽커 상태 문구·체크박스 유무, 체크박스 색, 보내기 모션. 시안 캡션이 붙인 가정 둘(끝난 시트의 제목 유지, 요청 시트 배경 달력의 시점)도 같이 본다.
