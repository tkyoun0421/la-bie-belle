...
- client-only UI state: React built-ins + domain hooks
- validation: `Zod`
- writes: Next.js `server actions`
- server reads: `queries/*/models/repositories`
- client query transport: `queries/*` 경계
...
- `queries/events/models/repositories/readEvents`
- `queries/events/models/repositories/readEventTemplates`
- `queries/applications/models/repositories/readMyApplications`
- `queries/assignments/models/repositories/readEventAssignments`
- `queries/replacements/models/repositories/readOpenReplacements`
- `queries/replacements/models/repositories/readReplacementCandidates`
- `queries/events/models/services/fetchEvents`
- `queries/events/models/services/getEventDetail`
- `queries/events/models/services/fetchEventTemplates`
- `queries/applications/models/services/fetchMyApplications`
- `queries/assignments/models/services/fetchEventAssignments`
- `queries/replacements/models/services/fetchOpenReplacements`
- `queries/replacements/models/services/fetchReplacementCandidates`

### Mutations

- `mutations/events/actions/createEventTemplate`
- `mutations/events/actions/createEvent`
- `mutations/applications/actions/applyToEvent`
- `mutations/applications/actions/cancelApplication`
- `mutations/assignments/actions/assignMember`
- `mutations/assignments/actions/requestCancelAssignment`
- `mutations/replacements/actions/applyToReplacement`
- `mutations/replacements/actions/approveReplacement`
- `mutations/replacements/actions/closeReplacement`
...
- list search term
- 현재 편집 중인 엔티티 id
- 방금 저장한 항목 highlight 같은 일시 UI 상태

규칙:

- 서버 데이터 캐시는 local state에 넣지 않는다
- domain truth는 query cache 또는 server render 결과만 사용한다
- local state owner는 가능한 해당 도메인의 `hooks/`가 된다
- `flows/_hooks`는 기본 구조가 아니다
