...
- **디자인 규칙의 정본은 `design/NOTES.md`다.** 라운드 1~25가 기록돼 있고 **전부 확정이다** —
...
NOTES의 「미결」 절이 정본이다. 남은 것 — `display` 32/40 처분, 모션 대역(`FOUNDATIONS.md:137`),
긴 이름 말줄임(`model` 몫), D 배지 낱개 검수, task 분할 여부(RADIO 직전).

문서 개정 목록(NOTES 맨 아래 표)에 라운드 24·25가 둘을 더했다 — `FOUNDATIONS.md:53`의 굵기
목록에 **500**을 들이는 것과, **블러 두 종**(금액 숨김 7px · 헤더 9px + 지면색 50%)을 적는 것.
...
- `docs/execution/runs/P0-T48/design/NOTES.md` (디자인 규칙 정본, 라운드 1~25)
- `docs/execution/runs/P0-T48/design/proposal.html` (라운드 25 확정 상태의 인터랙티브 시안)
