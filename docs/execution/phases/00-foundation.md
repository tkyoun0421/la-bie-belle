...
- 정적 청크 gzip 합계가 승인된 상한을 넘지 않는다. P0-T43이 확정한 420KB 위에서 개발 시점 실측으로 다시 정해 **500KB**가 됐다. 도입 전 기준선 406.5KB, 프로바이더만 배치한 실측 477.5KB, 구현을 마친 뒤의 최종 실측 490.9KB(502,710바이트)다. 근거는 ADR-0015다.
