...
### P0-T48. 전역 디자인 틀 확정과 홈·일정 퍼블리싱

목표: 앱 전체가 공유하는 틀을 확정해 **L3 정본으로 이관**하고, 그 틀이 실제로 서는지 홈·일정 두 화면으로 증명한다.
...
기획 승인: user, 2026-08-16 (범위 축소 2026-08-18). 개발 설계 승인: user, 2026-08-18.
