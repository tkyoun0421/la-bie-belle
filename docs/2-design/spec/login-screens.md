...
- [pages/login.md](../modules/account/screens/login.md)가 적은 두 화면이 실제로 돈다. 로그인하면 승인 상태에 따라 대기 화면이나 홈으로 갈린다. 세션 기반은 이미 깔려 있으니([session-foundation.md](../../3-build/plans/session-foundation.md)) 그 위에 화면만 얹는다.
