...
| 막대 위 시각 | 시작과 끝. 트랙 위에 뜬다 | `fg.neutral` |
| 지금 선 | 현재 시각 | `bg.brand-solid` |
| 지금 시각 라벨 | 선 위에 붙는다 | `fg.brand` |

시각은 「10:00–19:00」 한 덩이로 트랙 위에 뜨고 막대 왼쪽 끝에 맞춘다. 막대 안에 나눠 넣으면 짧은 근무에서 자리가 안 나온다 — 4시간 근무는 막대가 트랙의 27퍼센트라 시각 둘이 안 들어간다.

지금 시각 라벨과 같은 층이라 둘이 부딪힐 수 있다. 그때는 막대 시각이 오른쪽으로 물러난다 — 지금 시각은 선이 가리키는 자리를 지켜야 하고, 막대 시각은 막대 왼쪽 끝이 기본일 뿐 거기 붙어 있어야 하는 것이 아니다. 밀 때 막대 폭을 안 지킨다.

막대는 하나뿐이다. 근무 시간은 날짜마다 하나라 한 사람이 두 포지션을 맡아도 시간 축에 그릴 것이 하나다.
