...
- [tokens.md](tokens.md) — 모든 값의 정본. 팔레트, 역할 토큰, 타이포 스케일, 스페이싱, 라운딩, 그림자, 모션, 대비 검증. `src/app/globals.css`가 여기서 나온다
...
구현과의 앞뒤는 [roadmap](../../1-plan/roadmap.md#순서-규칙)이 정본이다 — 1차는 화면 디자인을 전부 끝낸 뒤 구현한다. 그리다 만나는 미정은 착수 전 인터뷰로 닫고, 그때까지는 페이지 문서의 「아직 안 정한 것」에 산다.
