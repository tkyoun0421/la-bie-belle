...
- **변경 알림 수신자는 변경 전후 배정자·교육생의 합집합이다.** 배정에서 빠진 사람도 받아 모르고 출근하는 사고를 막는다. 확정 스케줄 취소 알림 여부는 P4-T04 기획 소유로 이월. — [PRD 알림 절](PRD.md) · [phase P4-T04 절](../execution/phases/04-changes-and-notifications.md) (2026-08-16 기획)
