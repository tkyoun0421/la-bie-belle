...
- **담당자 없음 경고는 필요 인원 표에 없는 포지션도 포함한다.** 표에서 지워진 포지션에 배정자나 교육생이 남아 있으면 경고 대상이며, DB의 확정 경고 계산과 준비 화면 재계산이 같은 규칙을 쓴다. — [PRD 필요 인원과 배정 절](PRD.md) · [ADMIN-FLOWS 배정 절](design/ADMIN-FLOWS.md) (2026-08-16 기획)
