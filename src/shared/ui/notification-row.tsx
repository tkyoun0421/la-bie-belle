  ...
  return (
    <div className={className} style={style}>
      <button
        ...
        className="flex w-full items-start gap-2 border-b border-border py-3 text-left transition-transform duration-[var(--duration-feedback)] ease-[var(--ease-spring)]"
      >
