...
작은 매장의 근무표·출근·급여를 한곳에서 보는 웹 앱이다. 근무자는 근무표를 보고 신청하고 출근을 찍고 급여를 확인한다. 관리자는 근무표를 만들어 확정하고 가입과 사유를 승인한다. 무엇을 만드는지는 [PRD](docs/1-plan/prd.md)에, 용어와 규칙은 [domain](docs/2-design/domain/)에 있다.
