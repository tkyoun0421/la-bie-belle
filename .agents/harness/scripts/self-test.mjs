...
for (const id of ["harness-self-test", "index-schema", "hook-bypass", "task-contracts", "runner-contract-refusal", "runner-lifecycle", "runner-blocked", "readiness-runner-capability", "harness-regression"]) {
