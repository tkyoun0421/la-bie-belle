...
for (const id of ["harness-self-test", "development-guard", "skill-validators", "approval-workflow", "index-schema", "hook-bypass", "task-contracts", "runner-contract-refusal", "tdd-guard-acceptance", "runner-lifecycle", "runner-blocked", "readiness-runner-capability", "harness-regression"]) {
